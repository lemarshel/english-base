...
```
data/words-data.js        ← YOU EDIT THIS
  window.EN_WORDS         vocabulary records
  window.EN_GROUPS        root groups and where POS headings fall
        │
        └─ js/render-words.js   builds #word-tables-mount + the table of contents
                │
