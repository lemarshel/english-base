...
window.I18N = {
  ...
  en: {
    ...
    lbl_coca_profile: 'COCA use:',
    lbl_coca_rank: 'Frequency rank:',
    lbl_alpha: 'A–Z:',
    lbl_channels: 'Channels:',

    /* COCA vocabulary filters */
    coca_all: 'All profiles',
    coca_general: 'General',
    coca_conversational: 'Conversational',
    coca_academic: 'Academic',
    coca_fiction: 'Fiction',
    coca_news: 'News / Formal',
    coca_web: 'Web / Blog',
    coca_rank_min: 'Min',
    coca_rank_max: 'Max',
    coca_exclude_names: 'Exclude likely names/acronyms',
    coca_reset: 'Reset COCA',
  ...
  ru: {
    ...
    lbl_texts: 'Тексты:',
    lbl_pos: 'Часть речи:',
    lbl_coca_profile: 'Употребление COCA:',
    lbl_coca_rank: 'Частотный ранг:',
    lbl_alpha: 'А–Я:',
    lbl_channels: 'Каналы:',

    coca_all: 'Все профили',
    coca_general: 'Общая лексика',
    coca_conversational: 'Разговорная',
    coca_academic: 'Академическая',
    coca_fiction: 'Художественная',
    coca_news: 'Новости / формальная',
    coca_web: 'Веб / блоги',
    coca_rank_min: 'От',
    coca_rank_max: 'До',
    coca_exclude_names: 'Исключить вероятные имена/аббревиатуры',
    coca_reset: 'Сбросить COCA',
  ...
  kk: {
    ...
    lbl_texts: 'Мәтіндер:',
    lbl_pos: 'Сөз табы:',
    lbl_coca_profile: 'COCA қолданысы:',
    lbl_coca_rank: 'Жиілік рангі:',
    lbl_alpha: 'Ә–Я:',
    lbl_channels: 'Арналар:',

    coca_all: 'Барлық профильдер',
    coca_general: 'Жалпы',
    coca_conversational: 'Сөйлеу тілі',
    coca_academic: 'Академиялық',
    coca_fiction: 'Көркем әдебиет',
    coca_news: 'Жаңалықтар / ресми',
    coca_web: 'Веб / блог',
    coca_rank_min: 'Бастап',
    coca_rank_max: 'Дейін',
    coca_exclude_names: 'Ықтимал есімдер/қысқартуларды алып тастау',
    coca_reset: 'COCA сүзгісін тазалау',
