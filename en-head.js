...
(function(){
  try{
    ...
    var palName=localStorage.getItem('eng_palette')||'rose';
    var PALS={
      rose:['#e94560','#c73652'],
      ocean:['#0077b6','#005f8e'],
    ...
    var prefs={};
    try{prefs=JSON.parse(localStorage.getItem('eng_prefs')||'{}');}catch(e){}
    var css='';
    if(prefs.fz)css+='.wd{font-family:'+prefs.fz+',sans-serif!important}';
    if(prefs.sz)css+='.wd{font-size:'+prefs.sz+'px!important}';
    if(prefs.fp)css+='.ipa,.ex-ipa{font-family:'+prefs.fp+',sans-serif!important}';
    if(prefs.sp)css+='.ipa,.ex-ipa{font-size:'+prefs.sp+'px!important}';
